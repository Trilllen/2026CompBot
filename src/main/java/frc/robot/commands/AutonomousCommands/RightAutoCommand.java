...
public class RightAutoCommand extends Command {
  ...
  public RightAutoCommand(ClimberSubsystem climber, DriveSubsystem drive, IndexerSubsystem indexer, IntakeArmSubsystem intakeArm, LauncherSubsystem launcher) {
